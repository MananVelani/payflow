...
const file_proto_worker_proto_rawDesc = "" +
	...
	"\fReportResult\x12\x1d.payflow.worker.v1.TaskResult\x1a\x1c.payflow.worker.v1.ResultAckB\x16Z\x14payflow/proto/workerb\x06proto3"
...
var file_proto_worker_proto_depIdxs = []int32{
	...
	1, // 4: payflow.worker.v1.WorkerManagement.RegisterWorker:output_type -> payflow.worker.v1.RegisterResponse
	3, // 5: payflow.worker.v1.WorkerManagement.Heartbeat:output_type -> payflow.worker.v1.HeartbeatResponse
	5, // 6: payflow.worker.v1.WorkerManagement.PollTasks:output_type -> payflow.worker.v1.TaskAssignment
	7, // 7: payflow.worker.v1.WorkerManagement.ReportResult:output_type -> payflow.worker.v1.ResultAck
